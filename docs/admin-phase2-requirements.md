...
- Import hoặc seed được từng dòng từ workbook cũ trong `operations/`, tối thiểu từ các tab chuẩn:
  - `Nhập hàng`: từng sản phẩm nhập hàng, ngày, đối tác, nguồn/người bán, số lượng, đơn vị, đơn giá, thành tiền, dòng gốc, trạng thái có tính công nợ hay chỉ đối chiếu.
