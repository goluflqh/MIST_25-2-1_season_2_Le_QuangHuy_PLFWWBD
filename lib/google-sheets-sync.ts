...
export async function buildMinhHongSheetTabs(): Promise<SheetTab[]> {
  ...
  return [
    ...
    },
    {
      ...
      rows: [
        ["Mã", "Đối tác", "SĐT", "Loại", "Trạng thái", "Minh Hồng phải trả", "Đã mua", "Đã thanh toán", "Đã trả hàng", "Số dư chốt", "Dòng đối chiếu không tính nợ", "Số giao dịch", "Ghi chú", "Cập nhật"],
        ...partnerRows,
      ],
    },
    {
