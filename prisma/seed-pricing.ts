...
const pricingItems = [
  { category: "PIN", name: "Kiểm tra tình trạng pin", price: "Miễn phí", note: "Quyền lợi trước khi chốt sửa hoặc đóng lại", sortOrder: 1 },
  { category: "PIN", name: "Pin máy khoan / bắn vít", price: "350.000 - 800.000đ", note: "Tuỳ dung lượng & hãng", sortOrder: 2 },
  { category: "PIN", name: "Pin máy cắt / máy mài", price: "500.000 - 1.200.000đ", note: "Tuỳ số cell", sortOrder: 3 },
  { category: "PIN", name: "Pin xe đạp điện", price: "2.000.000 - 5.000.000đ", note: "Tuỳ Ah & loại xe", sortOrder: 4 },
  { category: "PIN", name: "Pin xe máy điện", price: "3.500.000 - 8.000.000đ", note: "Tuỳ dung lượng", sortOrder: 5 },
  { category: "PIN", name: "Pin loa kéo", price: "200.000 - 500.000đ", note: "Tuỳ hãng loa", sortOrder: 6 },
  { category: "PIN", name: "Pin laptop (thay cell)", price: "400.000 - 900.000đ", note: "Tuỳ hãng & model", sortOrder: 7 },
